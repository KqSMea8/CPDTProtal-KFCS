...
public class getMenuData_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[1];;
java.util.List treeNodes;
public getMenuData_biz(){
     __context.set("treeNodes",treeNodes);
}
public getMenuData_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("treeNodes",treeNodes);
}
public String getQName(){
  return "org.gocom.components.coframe.auth.LoginManager.getMenuData.biz";
}
public String getShortName(){
  return "getMenuData.bizx";
}
public List<Activity> getActivities(){
  if(this._eosInternal.activities==null){
    ...
    this._eosInternal.activities.add(new Activity("invokeSpring0","获取菜单数据","invoke"));
    this._eosInternal.activities.add(new Activity("invokeSpring1","根据应用ID获取菜单数据","invoke"));
  }
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __inputVariables[0].setName("appCode");
      ...
      __outputVariables[0].setName("treeNodes");
      __outputVariables[0].setTypeClass(java.util.List.class);
      __outputVariables[0].setTypeName("java.util.List");
...
private int start0(RuntimeContext __context,java.lang.String appCode) throws Throwable{
...
this.beforeHandlers("start0",__context);
  if(  com.primeton.ext.engine.core.SimpleConditionHelper.compare(appCode, (Object)null ,"NOTNULLANDEMPTY")){
...
private int end0(RuntimeContext __context,java.lang.String appCode) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
private int invokeSpring0(RuntimeContext __context,java.lang.String appCode) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
__context.setCurrentActivityName("获取菜单数据");
__context.setCurrentActivityType("invoke");
__context.setCurrentActivityValue(null);
this.beforeHandlers("invokeSpring0",__context);
try{
  Object[] __params =  new Object[0];
Class[]__paramTypes = new Class[0];
	  Object __return = com.eos.engine.core.EngineSpringInvokerFactory.getSpringInvoker().invoke("LoginServiceBean","getUserMenuTree",__paramTypes, __params);

__context.setList("treeNodes",__return);
    this.treeNodes=(java.util.List)com.primeton.engine.core.impl.helper.DataCopier.copyList(__context.getList("treeNodes"),java.util.List.class);
}finally{
}
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=获取菜单数据][activity id=invokeSpring0][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
private int invokeSpring1(RuntimeContext __context,java.lang.String appCode) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
boolean __oldStatusService = com.primeton.ext.access.ejb.jta.JtaContextManager.current().isWithinJta();
try{
__context.setCurrentActivityID("invokeSpring1");
__context.setCurrentActivityName("根据应用ID获取菜单数据");
__context.setCurrentActivityType("invoke");
__context.setCurrentActivityValue(null);
this.beforeHandlers("invokeSpring1",__context);
try{
  Object[] __params =  new Object[1];
__params[0] = com.primeton.ext.data.sdo.DataUtil.toString(appCode);
Class[]__paramTypes = new Class[1];
__paramTypes[0] = java.lang.String.class;
	  Object __return = com.eos.engine.core.EngineSpringInvokerFactory.getSpringInvoker().invoke("LoginServiceBean","getUserMenuTreeByAppCode",__paramTypes, __params);
...
__context.setList("treeNodes",__return);
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=根据应用ID获取菜单数据][activity id=invokeSpring1][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
public Object[] _invoke(java.lang.String appCode) throws Throwable{
       if(isSuspend()){
           return null;
       }
  __context.set("appCode",appCode);
  __context.set("treeNodes",treeNodes);
  __invokeBiz();
  return __results;
}
...
try{
 appCode = DataUtil.toString(__params[0]);
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:appCode ,Input param object type: "+__params[0].getClass().getName() +" not match with define:java.lang.String",new Object[]{this.getQName(),"appCode",__params[0].getClass().getName(),"java.lang.String"});
}
log.entry();
...
Object[] results =  _invoke(appCode);//2//
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  java.lang.String appCode;
      appCode=__context.getString("appCode");
    try{
      __eosCurrentActivityID=start0(__context,appCode);
      appCode=__context.getString("appCode");
__restoreField();
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  java.lang.String appCode;
      appCode=__context.getString("appCode");
    try{
      __eosCurrentActivityID=end0(__context,appCode);
      appCode=__context.getString("appCode");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokeSpring0(int __eosCurrentActivityID) throws Throwable{
  java.lang.String appCode;
      appCode=__context.getString("appCode");
    try{
      __eosCurrentActivityID=invokeSpring0(__context,appCode);
      appCode=__context.getString("appCode");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokeSpring1(int __eosCurrentActivityID) throws Throwable{
  java.lang.String appCode;
      appCode=__context.getString("appCode");
    try{
      __eosCurrentActivityID=invokeSpring1(__context,appCode);
      appCode=__context.getString("appCode");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }

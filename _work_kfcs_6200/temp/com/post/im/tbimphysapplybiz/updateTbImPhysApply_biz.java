...
public class updateTbImPhysApply_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
public updateTbImPhysApply_biz(){
}
public updateTbImPhysApply_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
}
public String getQName(){
  return "com.post.im.tbimphysapplybiz.updateTbImPhysApply.biz";
}
public String getShortName(){
  return "updateTbImPhysApply.bizx";
}
...
com.eos.foundation.database.DatabaseUtil.updateEntity("default",tbimphysapply);//pojo:invokePojo0//
if(isSuspend()){
return 70000;
}
}else{

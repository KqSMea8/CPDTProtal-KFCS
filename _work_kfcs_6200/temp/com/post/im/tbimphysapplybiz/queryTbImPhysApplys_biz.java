...
public class queryTbImPhysApplys_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] tbimphysapplys=new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/tbimphysapplys","java:null[]");}
{__context.addTypeMapping("xpath:/tbimphysapplys","sdo:com.post.im.resourceM.phys.phys.TbImPhysApply[]");}
int total;
public queryTbImPhysApplys_biz(){
     __context.set("tbimphysapplys",tbimphysapplys);
}
public queryTbImPhysApplys_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("tbimphysapplys",tbimphysapplys);
}
public String getQName(){
  return "com.post.im.tbimphysapplybiz.queryTbImPhysApplys.biz";
}
public String getShortName(){
  return "queryTbImPhysApplys.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.im.resourceM.phys.phys.TbImPhysApply");
      __outputVariables[0].setName("tbimphysapplys");
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.tbimphysapplys;
...
__context.set("tbimphysapplys",__return);
    this.tbimphysapplys=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimphysapplys"),commonj.sdo.DataObject.class);
{}
if(isSuspend()){
return 70000;
}

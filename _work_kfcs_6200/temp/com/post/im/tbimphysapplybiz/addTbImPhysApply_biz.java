package com.post.im.tbimphysapplybiz;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class addTbImPhysApply_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
public addTbImPhysApply_biz(){
}
public addTbImPhysApply_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
}
public String getQName(){
  return "com.post.im.tbimphysapplybiz.addTbImPhysApply.biz";
}
public String getShortName(){
  return "addTbImPhysApply.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __inputVariables[0].setDataObjectType("com.post.im.resourceM.phys.phys.TbImPhysApply");
      __inputVariables[0].setName("tbimphysapply");
...
private int start0(RuntimeContext __context,commonj.sdo.DataObject tbimphysapply) throws Throwable{
...
private int end0(RuntimeContext __context,commonj.sdo.DataObject tbimphysapply) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
private int invokePojo0(RuntimeContext __context,commonj.sdo.DataObject tbimphysapply) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
com.eos.foundation.database.DatabaseUtil.insertEntity("default",tbimphysapply);//pojo:invokePojo0//
if(isSuspend()){
return 70000;
}
}else{
...
private int invokePojo1(RuntimeContext __context,commonj.sdo.DataObject tbimphysapply) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
boolean __oldStatusService = com.primeton.ext.access.ejb.jta.JtaContextManager.current().isWithinJta();
try{
...
com.eos.foundation.database.DatabaseExt.getPrimaryKey(tbimphysapply);//pojo:invokePojo1//
if(isSuspend()){
return 70001;
}
}else{
...
private int subprocess0(RuntimeContext __context,commonj.sdo.DataObject tbimphysapply) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
private int invokeSpring0(RuntimeContext __context,commonj.sdo.DataObject tbimphysapply) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
boolean __oldStatusService = com.primeton.ext.access.ejb.jta.JtaContextManager.current().isWithinJta();
try{
...
try{
  Object[] __params =  new Object[1];
__params[0] = tbimphysapply;
Class[]__paramTypes = new Class[1];
__paramTypes[0] = commonj.sdo.DataObject.class;
	  Object __return = com.eos.engine.core.EngineSpringInvokerFactory.getSpringInvoker().invoke("PhysDetailBean","dataParseAdd",__paramTypes, __params);
...
public Object[] _invoke(commonj.sdo.DataObject tbimphysapply) throws Throwable{
       if(isSuspend()){
           return null;
       }
  __context.set("tbimphysapply",tbimphysapply);
  __invokeBiz();
  return __results;
}
...
commonj.sdo.DataObject tbimphysapply;
try{
 tbimphysapply = (commonj.sdo.DataObject)__params[0];
if(__params[0]==null){__context.addTypeMapping("xpath:/tbimphysapply","sdo:com.post.im.resourceM.phys.phys.TbImPhysApply");}
if(__params[0] != null){
  if(!(__params[0] instanceof commonj.sdo.DataObject)){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:tbimphysapply ,Input param object type: "+__params[0].getClass().getName() +" not match with define:commonj.sdo.DataObject:com.post.im.resourceM.phys.phys.TbImPhysApply",new Object[]{this.getQName(),"tbimphysapply",__params[0].getClass().getName(),"commonj.sdo.DataObject:com.post.im.resourceM.phys.phys.TbImPhysApply"});
  }
try{
  if(!"com.post.im.resourceM.phys.phys.TbImPhysApply".equals(((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName())){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100067,"Param Name:tbimphysapply ,Input param object type: "+((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName()+" not match with define:commonj.sdo.DataObject:com.post.im.resourceM.phys.phys.TbImPhysApply",new Object[]{this.getQName(),"tbimphysapply",((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName(),"commonj.sdo.DataObject:com.post.im.resourceM.phys.phys.TbImPhysApply"});
  }
 }
 catch(EOSEngineRuntimeException ___e){tracelog.warn(___e.getMessage());}}
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:tbimphysapply ,Input param object type: "+__params[0].getClass().getName() +" not match with define:commonj.sdo.DataObject",new Object[]{this.getQName(),"tbimphysapply",__params[0].getClass().getName(),"commonj.sdo.DataObject"});
}
log.entry();
...
Object[] results =  _invoke(tbimphysapply);//2//
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimphysapply;
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
    try{
      __eosCurrentActivityID=start0(__context,tbimphysapply);
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
__restoreField();
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimphysapply;
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
    try{
      __eosCurrentActivityID=end0(__context,tbimphysapply);
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokePojo0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimphysapply;
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
    try{
      __eosCurrentActivityID=invokePojo0(__context,tbimphysapply);
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokePojo1(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimphysapply;
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
    try{
      __eosCurrentActivityID=invokePojo1(__context,tbimphysapply);
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choicesubprocess0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimphysapply;
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
    try{
      __eosCurrentActivityID=subprocess0(__context,tbimphysapply);
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokeSpring0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimphysapply;
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
    try{
      __eosCurrentActivityID=invokeSpring0(__context,tbimphysapply);
      tbimphysapply=(commonj.sdo.DataObject)__context.getDataObject("tbimphysapply");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }

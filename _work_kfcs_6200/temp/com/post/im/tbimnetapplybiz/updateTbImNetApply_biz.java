...
public class updateTbImNetApply_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
public updateTbImNetApply_biz(){
}
public updateTbImNetApply_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
}
public String getQName(){
  return "com.post.im.tbimnetapplybiz.updateTbImNetApply.biz";
}
public String getShortName(){
  return "updateTbImNetApply.bizx";
}
...
com.eos.foundation.database.DatabaseUtil.updateEntity("default",tbimnetapply);//pojo:invokePojo0//
if(isSuspend()){
return 70000;
}
}else{

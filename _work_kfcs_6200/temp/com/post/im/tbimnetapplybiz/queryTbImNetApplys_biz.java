...
public class queryTbImNetApplys_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] tbimnetapplys=new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/tbimnetapplys","java:null[]");}
{__context.addTypeMapping("xpath:/tbimnetapplys","sdo:com.post.im.resourceM.net.net.TbImNetApply[]");}
int total;
public queryTbImNetApplys_biz(){
     __context.set("tbimnetapplys",tbimnetapplys);
}
public queryTbImNetApplys_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("tbimnetapplys",tbimnetapplys);
}
public String getQName(){
  return "com.post.im.tbimnetapplybiz.queryTbImNetApplys.biz";
}
public String getShortName(){
  return "queryTbImNetApplys.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.im.resourceM.net.net.TbImNetApply");
      __outputVariables[0].setName("tbimnetapplys");
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.tbimnetapplys;
...
__context.set("tbimnetapplys",__return);
    this.tbimnetapplys=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimnetapplys"),commonj.sdo.DataObject.class);
{}
if(isSuspend()){
return 70000;
}

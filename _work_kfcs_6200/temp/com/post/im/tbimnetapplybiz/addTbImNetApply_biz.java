package com.post.im.tbimnetapplybiz;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class addTbImNetApply_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
public addTbImNetApply_biz(){
}
public addTbImNetApply_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
}
public String getQName(){
  return "com.post.im.tbimnetapplybiz.addTbImNetApply.biz";
}
public String getShortName(){
  return "addTbImNetApply.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __inputVariables[0].setDataObjectType("com.post.im.resourceM.net.net.TbImNetApply");
      __inputVariables[0].setName("tbimnetapply");
...
private int start0(RuntimeContext __context,commonj.sdo.DataObject tbimnetapply) throws Throwable{
...
private int end0(RuntimeContext __context,commonj.sdo.DataObject tbimnetapply) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
private int invokePojo0(RuntimeContext __context,commonj.sdo.DataObject tbimnetapply) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
com.eos.foundation.database.DatabaseUtil.insertEntity("default",tbimnetapply);//pojo:invokePojo0//
if(isSuspend()){
return 70000;
}
}else{
...
private int invokePojo1(RuntimeContext __context,commonj.sdo.DataObject tbimnetapply) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
boolean __oldStatusService = com.primeton.ext.access.ejb.jta.JtaContextManager.current().isWithinJta();
try{
...
com.eos.foundation.database.DatabaseExt.getPrimaryKey(tbimnetapply);//pojo:invokePojo1//
if(isSuspend()){
return 70001;
}
}else{
...
public Object[] _invoke(commonj.sdo.DataObject tbimnetapply) throws Throwable{
       if(isSuspend()){
           return null;
       }
  __context.set("tbimnetapply",tbimnetapply);
  __invokeBiz();
  return __results;
}
...
commonj.sdo.DataObject tbimnetapply;
try{
 tbimnetapply = (commonj.sdo.DataObject)__params[0];
if(__params[0]==null){__context.addTypeMapping("xpath:/tbimnetapply","sdo:com.post.im.resourceM.net.net.TbImNetApply");}
if(__params[0] != null){
  if(!(__params[0] instanceof commonj.sdo.DataObject)){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:tbimnetapply ,Input param object type: "+__params[0].getClass().getName() +" not match with define:commonj.sdo.DataObject:com.post.im.resourceM.net.net.TbImNetApply",new Object[]{this.getQName(),"tbimnetapply",__params[0].getClass().getName(),"commonj.sdo.DataObject:com.post.im.resourceM.net.net.TbImNetApply"});
  }
try{
  if(!"com.post.im.resourceM.net.net.TbImNetApply".equals(((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName())){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100067,"Param Name:tbimnetapply ,Input param object type: "+((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName()+" not match with define:commonj.sdo.DataObject:com.post.im.resourceM.net.net.TbImNetApply",new Object[]{this.getQName(),"tbimnetapply",((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName(),"commonj.sdo.DataObject:com.post.im.resourceM.net.net.TbImNetApply"});
  }
 }
 catch(EOSEngineRuntimeException ___e){tracelog.warn(___e.getMessage());}}
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:tbimnetapply ,Input param object type: "+__params[0].getClass().getName() +" not match with define:commonj.sdo.DataObject",new Object[]{this.getQName(),"tbimnetapply",__params[0].getClass().getName(),"commonj.sdo.DataObject"});
}
log.entry();
...
Object[] results =  _invoke(tbimnetapply);//2//
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimnetapply;
      tbimnetapply=(commonj.sdo.DataObject)__context.getDataObject("tbimnetapply");
    try{
      __eosCurrentActivityID=start0(__context,tbimnetapply);
      tbimnetapply=(commonj.sdo.DataObject)__context.getDataObject("tbimnetapply");
__restoreField();
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimnetapply;
      tbimnetapply=(commonj.sdo.DataObject)__context.getDataObject("tbimnetapply");
    try{
      __eosCurrentActivityID=end0(__context,tbimnetapply);
      tbimnetapply=(commonj.sdo.DataObject)__context.getDataObject("tbimnetapply");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokePojo0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimnetapply;
      tbimnetapply=(commonj.sdo.DataObject)__context.getDataObject("tbimnetapply");
    try{
      __eosCurrentActivityID=invokePojo0(__context,tbimnetapply);
      tbimnetapply=(commonj.sdo.DataObject)__context.getDataObject("tbimnetapply");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokePojo1(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbimnetapply;
      tbimnetapply=(commonj.sdo.DataObject)__context.getDataObject("tbimnetapply");
    try{
      __eosCurrentActivityID=invokePojo1(__context,tbimnetapply);
      tbimnetapply=(commonj.sdo.DataObject)__context.getDataObject("tbimnetapply");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }

package com.post.im.tbimbackloginfobiz;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class deleteTbImBacklogInfos_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
commonj.sdo.DataObject temp=com.primeton.ext.data.sdo.helper.ExtendedDataFactory.eINSTANCE.create("com.post.im.backlog.backlog.TbImBacklogInfo");
{__context.addTypeMapping("xpath:/temp","java:null");}
{__context.addTypeMapping("xpath:/temp","sdo:com.post.im.backlog.backlog.TbImBacklogInfo");}
public deleteTbImBacklogInfos_biz(){
     __context.set("temp",temp);
}
public deleteTbImBacklogInfos_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("temp",temp);
}
public String getQName(){
  return "com.post.im.tbimbackloginfobiz.deleteTbImBacklogInfos.biz";
}
public String getShortName(){
  return "deleteTbImBacklogInfos.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __inputVariables[0].setDataObjectType("com.post.im.backlog.backlog.TbImBacklogInfo");
      __inputVariables[0].setName("tbimbackloginfos");
...
private int start0(RuntimeContext __context,commonj.sdo.DataObject[] tbimbackloginfos) throws Throwable{
...
private int end0(RuntimeContext __context,commonj.sdo.DataObject[] tbimbackloginfos) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
private int loopstart0(RuntimeContext __context,commonj.sdo.DataObject[] tbimbackloginfos) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
boolean isContinue = false;
  ...
  Object __tempO = (java.lang.Object)__context.get("tbimbackloginfos");
  if(__tempO != null){
   int __index = 0;
...
private int loopend0(RuntimeContext __context,commonj.sdo.DataObject[] tbimbackloginfos) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
   return 250000;
}
private int invokePojo0(RuntimeContext __context,commonj.sdo.DataObject[] tbimbackloginfos) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
public Object[] _invoke(commonj.sdo.DataObject[] tbimbackloginfos) throws Throwable{
       if(isSuspend()){
           return null;
       }
  __context.set("tbimbackloginfos",tbimbackloginfos);
  __context.set("temp",temp);
  __invokeBiz();
  return __results;
}
...
commonj.sdo.DataObject[] tbimbackloginfos;
try{
 tbimbackloginfos = (commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__params[0]);
if(tbimbackloginfos==null){__context.addTypeMapping("xpath:/tbimbackloginfos","sdo:com.post.im.backlog.backlog.TbImBacklogInfo[]");}
if(tbimbackloginfos != null){
  commonj.sdo.DataObject[] __rightDataObject = (commonj.sdo.DataObject[])tbimbackloginfos;
  for(int __i = 0;__i<__rightDataObject.length;__i++){
    if( !(__rightDataObject[__i] instanceof commonj.sdo.DataObject)){
      throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100067,"Param Name:tbimbackloginfos ,Input param object type: "+tbimbackloginfos.getClass().getName() +" not match with define:commonj.sdo.DataObject:com.post.im.backlog.backlog.TbImBacklogInfo",new Object[]{this.getQName(),"tbimbackloginfos",tbimbackloginfos.getClass().getName(),"commonj.sdo.DataObject:com.post.im.backlog.backlog.TbImBacklogInfo"});
    }
    if(!"com.post.im.backlog.backlog.TbImBacklogInfo".equals(((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getURI() + "." +((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getName()) ){
      throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100068,"Param Name:tbimbackloginfos ,Input param object type: "+((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getURI() + "." +((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getName()+" not match with define:commonj.sdo.DataObject:com.post.im.backlog.backlog.TbImBacklogInfo",new Object[]{this.getQName(),"tbimbackloginfos",((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getURI() + "." +((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getName(),"commonj.sdo.DataObject:com.post.im.backlog.backlog.TbImBacklogInfo"});
    }
  }
}
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:tbimbackloginfos ,Input param object type: "+__params[0].getClass().getName() +" not match with define:commonj.sdo.DataObject",new Object[]{this.getQName(),"tbimbackloginfos",__params[0].getClass().getName(),"commonj.sdo.DataObject"});
}
log.entry();
...
Object[] results =  _invoke(tbimbackloginfos);//2//
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbimbackloginfos;
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=start0(__context,tbimbackloginfos);
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
__restoreField();
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbimbackloginfos;
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=end0(__context,tbimbackloginfos);
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceloopstart0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbimbackloginfos;
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=loopstart0(__context,tbimbackloginfos);
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceloopend0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbimbackloginfos;
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=loopend0(__context,tbimbackloginfos);
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokePojo0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbimbackloginfos;
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=invokePojo0(__context,tbimbackloginfos);
      tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }

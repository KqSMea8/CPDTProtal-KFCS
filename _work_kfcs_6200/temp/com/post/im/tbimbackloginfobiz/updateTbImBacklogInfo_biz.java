...
public class updateTbImBacklogInfo_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
public updateTbImBacklogInfo_biz(){
}
public updateTbImBacklogInfo_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
}
public String getQName(){
  return "com.post.im.tbimbackloginfobiz.updateTbImBacklogInfo.biz";
}
public String getShortName(){
  return "updateTbImBacklogInfo.bizx";
}
...
com.eos.foundation.database.DatabaseUtil.updateEntity("default",tbimbackloginfo);//pojo:invokePojo0//
if(isSuspend()){
return 70000;
}
}else{

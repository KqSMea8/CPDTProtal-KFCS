...
public class queryTbImBacklogInfos_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] tbimbackloginfos=new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/tbimbackloginfos","java:null[]");}
{__context.addTypeMapping("xpath:/tbimbackloginfos","sdo:com.post.im.backlog.backlog.TbImBacklogInfo[]");}
int total;
public queryTbImBacklogInfos_biz(){
     __context.set("tbimbackloginfos",tbimbackloginfos);
}
public queryTbImBacklogInfos_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("tbimbackloginfos",tbimbackloginfos);
}
public String getQName(){
  return "com.post.im.tbimbackloginfobiz.queryTbImBacklogInfos.biz";
}
public String getShortName(){
  return "queryTbImBacklogInfos.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.im.backlog.backlog.TbImBacklogInfo");
      __outputVariables[0].setName("tbimbackloginfos");
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.tbimbackloginfos;
...
__context.set("tbimbackloginfos",__return);
    this.tbimbackloginfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimbackloginfos"),commonj.sdo.DataObject.class);
{}
if(isSuspend()){
return 70000;
}

package com.post.im.itemsM.resoAplyAppr;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class resoApluApprQuery_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] tblmApplyApprInfo=new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/tblmApplyApprInfo","java:null[]");}
{__context.addTypeMapping("xpath:/tblmApplyApprInfo","sdo:com.post.im.resoAplyAppr.TbImApplyAppr[]");}
int total;
public resoApluApprQuery_biz(){
     __context.set("tblmApplyApprInfo",tblmApplyApprInfo);
}
public resoApluApprQuery_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("tblmApplyApprInfo",tblmApplyApprInfo);
}
public String getQName(){
  return "com.post.im.itemsM.resoAplyAppr.resoApluApprQuery.biz";
}
public String getShortName(){
  return "resoApluApprQuery";
}
public List<Activity> getActivities(){
  if(this._eosInternal.activities==null){
    ...
    this._eosInternal.activities.add(new Activity("invokePojo0","查询信息","invoke"));
    this._eosInternal.activities.add(new Activity("assign0","统计总记录数","assign"));
    this._eosInternal.activities.add(new Activity("assign1","设置统计总记录数","assign"));
  }
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.im.resoAplyAppr.TbImApplyAppr");
      __outputVariables[0].setName("tblmApplyApprInfo");
...
private int start0(RuntimeContext __context,commonj.sdo.DataObject criteria,commonj.sdo.DataObject page) throws Throwable{
...
private int end0(RuntimeContext __context,commonj.sdo.DataObject criteria,commonj.sdo.DataObject page) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.tblmApplyApprInfo;
  __results[1]=com.primeton.ext.data.sdo.DataUtil.toInt(this.total);
...
private int invokePojo0(RuntimeContext __context,commonj.sdo.DataObject criteria,commonj.sdo.DataObject page) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
__context.setCurrentActivityName("查询信息");
...
__context.set("tblmApplyApprInfo",__return);
    this.tblmApplyApprInfo=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tblmApplyApprInfo"),commonj.sdo.DataObject.class);
{}
if(isSuspend()){
return 70000;
}
 ...
 if(EngineConfigHandler.getEngineConfigModel().getLogPojoWhenTimeout() >= 0 ){
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=查询信息][activity id=invokePojo0][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
private int assign0(RuntimeContext __context,commonj.sdo.DataObject criteria,commonj.sdo.DataObject page) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
__context.setCurrentActivityID("assign0");
__context.setCurrentActivityName("统计总记录数");
...
this.beforeHandlers("assign0",__context);
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=统计总记录数][activity id=assign0][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
private int assign1(RuntimeContext __context,commonj.sdo.DataObject criteria,commonj.sdo.DataObject page) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
__context.setCurrentActivityID("assign1");
__context.setCurrentActivityName("设置统计总记录数");
__context.setCurrentActivityType("assign");
__context.setCurrentActivityValue(null);
this.beforeHandlers("assign1",__context);
  __context.set("total",__context.getInt("page/count"));
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=设置统计总记录数][activity id=assign1][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
public Object[] _invoke(commonj.sdo.DataObject criteria,commonj.sdo.DataObject page) throws Throwable{
       if(isSuspend()){
           return null;
       }
...
Object[] results =  _invoke(criteria,page);//2//
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject page;
      ...
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
    try{
      __eosCurrentActivityID=start0(__context,criteria,page);
      criteria=(commonj.sdo.DataObject)__context.getDataObject("criteria");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
__restoreField();
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject page;
      ...
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
    try{
      __eosCurrentActivityID=end0(__context,criteria,page);
      criteria=(commonj.sdo.DataObject)__context.getDataObject("criteria");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
...
private int __choiceinvokePojo0(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject page;
      ...
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
    try{
      __eosCurrentActivityID=invokePojo0(__context,criteria,page);
      criteria=(commonj.sdo.DataObject)__context.getDataObject("criteria");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
...
private int __choiceassign0(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject page;
      ...
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
    try{
      __eosCurrentActivityID=assign0(__context,criteria,page);
      criteria=(commonj.sdo.DataObject)__context.getDataObject("criteria");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
...
private int __choiceassign1(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject page;
      ...
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
    try{
      __eosCurrentActivityID=assign1(__context,criteria,page);
      criteria=(commonj.sdo.DataObject)__context.getDataObject("criteria");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);

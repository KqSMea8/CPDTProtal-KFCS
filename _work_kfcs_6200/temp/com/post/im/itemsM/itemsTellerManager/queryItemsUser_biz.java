package com.post.im.itemsM.itemsTellerManager;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class queryItemsUser_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] ItemsUserInfos= new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/ItemsUserInfos","java:null[]");}
int total;
public queryItemsUser_biz(){
     __context.set("ItemsUserInfos",ItemsUserInfos);
}
public queryItemsUser_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("ItemsUserInfos",ItemsUserInfos);
}
public String getQName(){
  return "com.post.im.itemsM.itemsTellerManager.queryItemsUser.biz";
}
public String getShortName(){
  return "queryItemsUser.bizx";
}
public List<Activity> getActivities(){
  if(this._eosInternal.activities==null){
    ...
    this._eosInternal.activities.add(new Activity("invokePojo0","queryItemsUserList","invoke"));
  }
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __inputVariables[4] = new Variable();
      __inputVariables[4].setArray(false);
      __inputVariables[4].setCategory(3);
      __inputVariables[4].setDataObjectType("com.primeton.das.criteria.criteriaType");
      __inputVariables[4].setName("criteria");
      __inputVariables[4].setTypeClass(commonj.sdo.DataObject.class);
      __inputVariables[4].setTypeName("commonj.sdo.DataObject");

      Variable[]__outputVariables = new Variable[2];
      __outputVariables[0] = new Variable();
      __outputVariables[0].setArray(true);
      __outputVariables[0].setCategory(2);
      __outputVariables[0].setName("ItemsUserInfos");
...
private int start0(RuntimeContext __context,java.lang.String itemsCd,commonj.sdo.DataObject page,int pageIndex,int pageSize,commonj.sdo.DataObject criteria) throws Throwable{
...
private int end0(RuntimeContext __context,java.lang.String itemsCd,commonj.sdo.DataObject page,int pageIndex,int pageSize,commonj.sdo.DataObject criteria) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.ItemsUserInfos;
...
private int assign0(RuntimeContext __context,java.lang.String itemsCd,commonj.sdo.DataObject page,int pageIndex,int pageSize,commonj.sdo.DataObject criteria) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
this.beforeHandlers("assign0",__context);
  ...
  page = (commonj.sdo.DataObject)__context.getDataObject("page");
  __context.set("itemsCd",__context.getString("criteria/_expr/itemsCd"));
  itemsCd = __context.getString("itemsCd");
...
private int invokePojo0(RuntimeContext __context,java.lang.String itemsCd,commonj.sdo.DataObject page,int pageIndex,int pageSize,commonj.sdo.DataObject criteria) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
__context.setCurrentActivityName("queryItemsUserList");
__context.setCurrentActivityType("invoke");
__context.setCurrentActivityValue("com.post.im.itemsM.ItemsTeamManager.queryItemsUserList");
this.beforeHandlers("invokePojo0",__context);
long __startTime=System.currentTimeMillis();
try{
com.post.im.itemsM.ItemsTeamManager __instance = new com.post.im.itemsM.ItemsTeamManager();
  __resumeException();
   if(!__context.getAttributes().containsKey("invokePojo0__suspend")){
	  Object __return = __instance.queryItemsUserList(com.primeton.ext.data.sdo.DataUtil.toString(itemsCd),page);//pojo:invokePojo0//
__context.set("ItemsUserInfos",__return);
    this.ItemsUserInfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("ItemsUserInfos"),commonj.sdo.DataObject.class);
if(isSuspend()){
return 70000;
}
}else{
 ...
 if(EngineConfigHandler.getEngineConfigModel().getLogPojoWhenTimeout() >= 0 ){
  ...
  if (__executeTime >= EngineConfigHandler.getEngineConfigModel().getLogPojoWhenTimeout()) {
    com.primeton.ext.common.logging.LoggerFactory.getPojoSysLogger().perform("com.post.im.itemsM.ItemsTeamManager.queryItemsUserList", String.valueOf(__executeTime));
  }
 }
}
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=queryItemsUserList][activity id=invokePojo0][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
public Object[] _invoke(java.lang.String itemsCd,commonj.sdo.DataObject page,int pageIndex,int pageSize,commonj.sdo.DataObject criteria) throws Throwable{
       if(isSuspend()){
           return null;
       }
  __context.set("itemsCd",itemsCd);
  __context.set("page",page);
  __context.set("pageIndex",pageIndex);
  __context.set("pageSize",pageSize);
...
java.lang.String itemsCd;
try{
 itemsCd = DataUtil.toString(__params[0]);
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:itemsCd ,Input param object type: "+__params[0].getClass().getName() +" not match with define:java.lang.String",new Object[]{this.getQName(),"itemsCd",__params[0].getClass().getName(),"java.lang.String"});
}
...
try{
 criteria = (commonj.sdo.DataObject)__params[4];
if(__params[4]==null){__context.addTypeMapping("xpath:/criteria","sdo:com.primeton.das.criteria.criteriaType");}
if(__params[4] != null){
  if(!(__params[4] instanceof commonj.sdo.DataObject)){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:criteria ,Input param object type: "+__params[4].getClass().getName() +" not match with define:commonj.sdo.DataObject:com.primeton.das.criteria.criteriaType",new Object[]{this.getQName(),"criteria",__params[4].getClass().getName(),"commonj.sdo.DataObject:com.primeton.das.criteria.criteriaType"});
  }
try{
  if(!"com.primeton.das.criteria.criteriaType".equals(((commonj.sdo.DataObject)__params[4]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[4]).getType().getName())){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100067,"Param Name:criteria ,Input param object type: "+((commonj.sdo.DataObject)__params[4]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[4]).getType().getName()+" not match with define:commonj.sdo.DataObject:com.primeton.das.criteria.criteriaType",new Object[]{this.getQName(),"criteria",((commonj.sdo.DataObject)__params[4]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[4]).getType().getName(),"commonj.sdo.DataObject:com.primeton.das.criteria.criteriaType"});
  }
 }
 catch(EOSEngineRuntimeException ___e){tracelog.warn(___e.getMessage());}}
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:criteria ,Input param object type: "+__params[4].getClass().getName() +" not match with define:commonj.sdo.DataObject",new Object[]{this.getQName(),"criteria",__params[4].getClass().getName(),"commonj.sdo.DataObject"});
}
log.entry();
...
Object[] results =  _invoke(itemsCd,page,pageIndex,pageSize,criteria);//2//
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject criteria;
    ...
    try{
      __eosCurrentActivityID=start0(__context,itemsCd,page,pageIndex,pageSize,criteria);
      itemsCd=__context.getString("itemsCd");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
      pageIndex=__context.getInt("pageIndex");
      pageSize=__context.getInt("pageSize");
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject criteria;
      ...
      criteria=(commonj.sdo.DataObject)__context.getDataObject("criteria");
    try{
      __eosCurrentActivityID=end0(__context,itemsCd,page,pageIndex,pageSize,criteria);
      itemsCd=__context.getString("itemsCd");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
      pageIndex=__context.getInt("pageIndex");
      pageSize=__context.getInt("pageSize");
...
private int __choiceassign0(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject criteria;
      ...
      criteria=(commonj.sdo.DataObject)__context.getDataObject("criteria");
    try{
      __eosCurrentActivityID=assign0(__context,itemsCd,page,pageIndex,pageSize,criteria);
      itemsCd=__context.getString("itemsCd");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
      pageIndex=__context.getInt("pageIndex");
      pageSize=__context.getInt("pageSize");
...
private int __choiceinvokePojo0(int __eosCurrentActivityID) throws Throwable{
  ...
  commonj.sdo.DataObject criteria;
      ...
      criteria=(commonj.sdo.DataObject)__context.getDataObject("criteria");
    try{
      __eosCurrentActivityID=invokePojo0(__context,itemsCd,page,pageIndex,pageSize,criteria);
      itemsCd=__context.getString("itemsCd");
      page=(commonj.sdo.DataObject)__context.getDataObject("page");
      pageIndex=__context.getInt("pageIndex");
      pageSize=__context.getInt("pageSize");

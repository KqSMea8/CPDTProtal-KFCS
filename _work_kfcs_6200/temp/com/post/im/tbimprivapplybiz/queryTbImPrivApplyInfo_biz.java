...
public class queryTbImPrivApplyInfo_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[1];;
commonj.sdo.DataObject data=com.primeton.ext.data.sdo.helper.ExtendedDataFactory.eINSTANCE.create("com.post.im.resourceM.priv.priv.TbImPrivApply");
{__context.addTypeMapping("xpath:/data","java:null");}
{__context.addTypeMapping("xpath:/data","sdo:com.post.im.resourceM.priv.priv.TbImPrivApply");}
public queryTbImPrivApplyInfo_biz(){
     __context.set("data",data);
}
public queryTbImPrivApplyInfo_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("data",data);
}
public String getQName(){
  return "com.post.im.tbimprivapplybiz.queryTbImPrivApplyInfo.biz";
}
public String getShortName(){
  return "queryTbImPrivApplyInfo.bizx";
}
public List<Activity> getActivities(){
  if(this._eosInternal.activities==null){
    ...
    this._eosInternal.activities.add(new Activity("invokeSpring0","获取申请信息","invoke"));
  }
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __inputVariables[0].setName("resourceId");
      ...
      __outputVariables[0].setDataObjectType("com.post.im.resourceM.priv.priv.TbImPrivApply");
      __outputVariables[0].setName("data");
...
private int start0(RuntimeContext __context,java.lang.String resourceId) throws Throwable{
...
private int end0(RuntimeContext __context,java.lang.String resourceId) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
private int invokeSpring0(RuntimeContext __context,java.lang.String resourceId) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
__context.setCurrentActivityName("获取申请信息");
__context.setCurrentActivityType("invoke");
__context.setCurrentActivityValue(null);
this.beforeHandlers("invokeSpring0",__context);
try{
  Object[] __params =  new Object[1];
__params[0] = com.primeton.ext.data.sdo.DataUtil.toString(resourceId);
Class[]__paramTypes = new Class[1];
__paramTypes[0] = java.lang.String.class;
	  Object __return = com.eos.engine.core.EngineSpringInvokerFactory.getSpringInvoker().invoke("PrivApplyBean","getTbImPrivApply",__paramTypes, __params);

__context.setDataObject("data",__return);
    this.data=(commonj.sdo.DataObject)__context.getDataObject("data");
{DataObject _____tmp = (DataObject)this.data;
if(_____tmp!=null){
com.primeton.engine.core.impl.helper.DataBuilder.checkedDataObjectIsAssignableFrom(_____tmp,"com.post.im.resourceM.priv.priv.TbImPrivApply");
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=获取申请信息][activity id=invokeSpring0][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
public Object[] _invoke(java.lang.String resourceId) throws Throwable{
       if(isSuspend()){
           return null;
       }
  __context.set("resourceId",resourceId);
  __context.set("data",data);
  __invokeBiz();
  return __results;
}
...
try{
 resourceId = DataUtil.toString(__params[0]);
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:resourceId ,Input param object type: "+__params[0].getClass().getName() +" not match with define:java.lang.String",new Object[]{this.getQName(),"resourceId",__params[0].getClass().getName(),"java.lang.String"});
}
log.entry();
...
Object[] results =  _invoke(resourceId);//2//
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  java.lang.String resourceId;
      resourceId=__context.getString("resourceId");
    try{
      __eosCurrentActivityID=start0(__context,resourceId);
      resourceId=__context.getString("resourceId");
__restoreField();
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  java.lang.String resourceId;
      resourceId=__context.getString("resourceId");
    try{
      __eosCurrentActivityID=end0(__context,resourceId);
      resourceId=__context.getString("resourceId");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokeSpring0(int __eosCurrentActivityID) throws Throwable{
  java.lang.String resourceId;
      resourceId=__context.getString("resourceId");
    try{
      __eosCurrentActivityID=invokeSpring0(__context,resourceId);
      resourceId=__context.getString("resourceId");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }

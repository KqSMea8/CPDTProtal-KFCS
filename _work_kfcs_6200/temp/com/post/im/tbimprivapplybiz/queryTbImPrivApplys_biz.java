...
public class queryTbImPrivApplys_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] tbimprivapplys=new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/tbimprivapplys","java:null[]");}
{__context.addTypeMapping("xpath:/tbimprivapplys","sdo:com.post.im.resourceM.priv.priv.TbImPrivApply[]");}
int total;
public queryTbImPrivApplys_biz(){
     __context.set("tbimprivapplys",tbimprivapplys);
}
public queryTbImPrivApplys_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("tbimprivapplys",tbimprivapplys);
}
public String getQName(){
  return "com.post.im.tbimprivapplybiz.queryTbImPrivApplys.biz";
}
public String getShortName(){
  return "queryTbImPrivApplys.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setName("tbimprivapplys");
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.tbimprivapplys;
...
__context.set("tbimprivapplys",__return);
    this.tbimprivapplys=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbimprivapplys"),commonj.sdo.DataObject.class);
{}
if(isSuspend()){
return 70000;
}

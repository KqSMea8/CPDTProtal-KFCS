...
public class updateTbImPrivApply_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
public updateTbImPrivApply_biz(){
}
public updateTbImPrivApply_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
}
public String getQName(){
  return "com.post.im.tbimprivapplybiz.updateTbImPrivApply.biz";
}
public String getShortName(){
  return "updateTbImPrivApply.bizx";
}
public List<Activity> getActivities(){
  if(this._eosInternal.activities==null){
    ...
    this._eosInternal.activities.add(new Activity("subprocess1","updateTbImBacklogInfo","subprocess"));
...
__context.setCurrentActivityName("updateTbImBacklogInfo");
__context.setCurrentActivityType("subprocess");
__context.setCurrentActivityValue("com.post.im.tbimbackloginfobiz.updateTbImBacklogInfo");
...
try{
  if(txProxy.getStatus() != com.eos.common.transaction.ITransactionManager.Status.STATUS_NO_TRANSACTION){
    ...
    String __optName = "updateTbImBacklogInfo";
try{
    ILogicComponent __component = new ServiceContext().locateBizLogic(__appName+__componentName);
  Object[] __params =  new Object[1];
...
com.primeton.ext.access.ejb.jta.JtaContextManager.current().setWithinJta(__oldStatus);
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=updateTbImBacklogInfo][activity id=subprocess1][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
Class[]__paramTypes = new Class[1];
__paramTypes[0] = commonj.sdo.DataObject.class;
	  Object __return = com.eos.engine.core.EngineSpringInvokerFactory.getSpringInvoker().invoke("PrivBacklogBean","dataParseToBacklogUpdate",__paramTypes, __params);

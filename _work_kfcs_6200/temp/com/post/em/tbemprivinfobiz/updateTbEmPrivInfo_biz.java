...
public class updateTbEmPrivInfo_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
public updateTbEmPrivInfo_biz(){
}
public updateTbEmPrivInfo_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
}
public String getQName(){
  return "com.post.em.tbemprivinfobiz.updateTbEmPrivInfo.biz";
}
public String getShortName(){
  return "updateTbEmPrivInfo.bizx";
}
...
com.eos.foundation.database.DatabaseUtil.updateEntity("default",tbemprivinfo);//pojo:invokePojo0//
if(isSuspend()){
return 70000;
}
}else{

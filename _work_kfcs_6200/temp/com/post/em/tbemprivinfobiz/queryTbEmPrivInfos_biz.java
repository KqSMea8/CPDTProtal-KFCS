...
public class queryTbEmPrivInfos_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] tbemprivinfos=new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/tbemprivinfos","java:null[]");}
{__context.addTypeMapping("xpath:/tbemprivinfos","sdo:com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo[]");}
int total;
public queryTbEmPrivInfos_biz(){
     __context.set("tbemprivinfos",tbemprivinfos);
}
public queryTbEmPrivInfos_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("tbemprivinfos",tbemprivinfos);
}
public String getQName(){
  return "com.post.em.tbemprivinfobiz.queryTbEmPrivInfos.biz";
}
public String getShortName(){
  return "queryTbEmPrivInfos.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo");
      __outputVariables[0].setName("tbemprivinfos");
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.tbemprivinfos;
...
__context.set("tbemprivinfos",__return);
    this.tbemprivinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivinfos"),commonj.sdo.DataObject.class);
{}
if(isSuspend()){
return 70000;
}

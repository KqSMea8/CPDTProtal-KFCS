package com.post.em.tbemprivinfobiz;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class addTbEmPrivInfo_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[0];;
public addTbEmPrivInfo_biz(){
}
public addTbEmPrivInfo_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
}
public String getQName(){
  return "com.post.em.tbemprivinfobiz.addTbEmPrivInfo.biz";
}
public String getShortName(){
  return "addTbEmPrivInfo.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __inputVariables[0].setDataObjectType("com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo");
      __inputVariables[0].setName("tbemprivinfo");
...
private int start0(RuntimeContext __context,commonj.sdo.DataObject tbemprivinfo) throws Throwable{
...
private int end0(RuntimeContext __context,commonj.sdo.DataObject tbemprivinfo) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
private int invokePojo0(RuntimeContext __context,commonj.sdo.DataObject tbemprivinfo) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
com.eos.foundation.database.DatabaseUtil.insertEntity("default",tbemprivinfo);//pojo:invokePojo0//
if(isSuspend()){
return 70000;
}
}else{
...
private int invokePojo1(RuntimeContext __context,commonj.sdo.DataObject tbemprivinfo) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
boolean __oldStatusService = com.primeton.ext.access.ejb.jta.JtaContextManager.current().isWithinJta();
try{
...
com.eos.foundation.database.DatabaseExt.getPrimaryKey(tbemprivinfo);//pojo:invokePojo1//
if(isSuspend()){
return 70001;
}
}else{
...
public Object[] _invoke(commonj.sdo.DataObject tbemprivinfo) throws Throwable{
       if(isSuspend()){
           return null;
       }
  __context.set("tbemprivinfo",tbemprivinfo);
  __invokeBiz();
  return __results;
}
...
commonj.sdo.DataObject tbemprivinfo;
try{
 tbemprivinfo = (commonj.sdo.DataObject)__params[0];
if(__params[0]==null){__context.addTypeMapping("xpath:/tbemprivinfo","sdo:com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo");}
if(__params[0] != null){
  if(!(__params[0] instanceof commonj.sdo.DataObject)){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:tbemprivinfo ,Input param object type: "+__params[0].getClass().getName() +" not match with define:commonj.sdo.DataObject:com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo",new Object[]{this.getQName(),"tbemprivinfo",__params[0].getClass().getName(),"commonj.sdo.DataObject:com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo"});
  }
try{
  if(!"com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo".equals(((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName())){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100067,"Param Name:tbemprivinfo ,Input param object type: "+((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName()+" not match with define:commonj.sdo.DataObject:com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo",new Object[]{this.getQName(),"tbemprivinfo",((commonj.sdo.DataObject)__params[0]).getType().getURI() + "." +((commonj.sdo.DataObject)__params[0]).getType().getName(),"commonj.sdo.DataObject:com.post.em.baseInfo.emPrivInfo.TbEmPrivInfo"});
  }
 }
 catch(EOSEngineRuntimeException ___e){tracelog.warn(___e.getMessage());}}
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:tbemprivinfo ,Input param object type: "+__params[0].getClass().getName() +" not match with define:commonj.sdo.DataObject",new Object[]{this.getQName(),"tbemprivinfo",__params[0].getClass().getName(),"commonj.sdo.DataObject"});
}
log.entry();
...
Object[] results =  _invoke(tbemprivinfo);//2//
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbemprivinfo;
      tbemprivinfo=(commonj.sdo.DataObject)__context.getDataObject("tbemprivinfo");
    try{
      __eosCurrentActivityID=start0(__context,tbemprivinfo);
      tbemprivinfo=(commonj.sdo.DataObject)__context.getDataObject("tbemprivinfo");
__restoreField();
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbemprivinfo;
      tbemprivinfo=(commonj.sdo.DataObject)__context.getDataObject("tbemprivinfo");
    try{
      __eosCurrentActivityID=end0(__context,tbemprivinfo);
      tbemprivinfo=(commonj.sdo.DataObject)__context.getDataObject("tbemprivinfo");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokePojo0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbemprivinfo;
      tbemprivinfo=(commonj.sdo.DataObject)__context.getDataObject("tbemprivinfo");
    try{
      __eosCurrentActivityID=invokePojo0(__context,tbemprivinfo);
      tbemprivinfo=(commonj.sdo.DataObject)__context.getDataObject("tbemprivinfo");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokePojo1(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject tbemprivinfo;
      tbemprivinfo=(commonj.sdo.DataObject)__context.getDataObject("tbemprivinfo");
    try{
      __eosCurrentActivityID=invokePojo1(__context,tbemprivinfo);
      tbemprivinfo=(commonj.sdo.DataObject)__context.getDataObject("tbemprivinfo");
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }

package com.post.em.tbemphysinfobiz;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class queryTbEmPhysInfos_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] tbemphysinfos=new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/tbemphysinfos","java:null[]");}
{__context.addTypeMapping("xpath:/tbemphysinfos","sdo:com.post.em.baseInfo.phys.TbEmPhysInfo[]");}
int total;
public queryTbEmPhysInfos_biz(){
     __context.set("tbemphysinfos",tbemphysinfos);
}
public queryTbEmPhysInfos_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("tbemphysinfos",tbemphysinfos);
}
public String getQName(){
  return "com.post.em.tbemphysinfobiz.queryTbEmPhysInfos.biz";
}
public String getShortName(){
  return "queryTbEmPhysInfos.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.em.baseInfo.phys.TbEmPhysInfo");
      __outputVariables[0].setName("tbemphysinfos");
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.tbemphysinfos;
...
__context.set("tbemphysinfos",__return);
    this.tbemphysinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemphysinfos"),commonj.sdo.DataObject.class);
{}
if(isSuspend()){
return 70000;
}

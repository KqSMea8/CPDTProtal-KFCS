package com.post.em.tbimitemsinfobiz;
import java.io.*;
import java.util.*;
import java.math.*;
...
{__context.addTypeMapping("xpath:/tbimitemsinfos","sdo:com.post.em.baseInfo.item.TbImItemsInfo[]");}
int total;
...
public String getQName(){
  return "com.post.em.tbimitemsinfobiz.queryTbImItemsInfos.biz";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.em.baseInfo.item.TbImItemsInfo");

package com.post.em.tbemprivecsinfobiz;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class deleteTbEmPrivEcsInfos_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
...
public deleteTbEmPrivEcsInfos_biz(){
     __context.set("temp",temp);
}
public deleteTbEmPrivEcsInfos_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("temp",temp);
}
public String getQName(){
  return "com.post.em.tbemprivecsinfobiz.deleteTbEmPrivEcsInfos.biz";
}
public String getShortName(){
  return "deleteTbEmPrivEcsInfos.bizx";
}
...
private int loopstart0(RuntimeContext __context,commonj.sdo.DataObject[] tbemprivecsinfos) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
boolean isContinue = false;
  ...
  Object __tempO = (java.lang.Object)__context.get("tbemprivecsinfos");
  if(__tempO != null){
   int __index = 0;
...
private int loopend0(RuntimeContext __context,commonj.sdo.DataObject[] tbemprivecsinfos) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
   return 250000;
}
...
private int __choiceloopstart0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbemprivecsinfos;
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=loopstart0(__context,tbemprivecsinfos);
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceloopend0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbemprivecsinfos;
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=loopend0(__context,tbemprivecsinfos);
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }

...
public class queryTbEmPrivEcsInfos_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[2];;
commonj.sdo.DataObject[] tbemprivecsinfos=new commonj.sdo.DataObject[]{};
{__context.addTypeMapping("xpath:/tbemprivecsinfos","java:null[]");}
{__context.addTypeMapping("xpath:/tbemprivecsinfos","sdo:com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo[]");}
int total;
public queryTbEmPrivEcsInfos_biz(){
     __context.set("tbemprivecsinfos",tbemprivecsinfos);
}
public queryTbEmPrivEcsInfos_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("tbemprivecsinfos",tbemprivecsinfos);
}
public String getQName(){
  return "com.post.em.tbemprivecsinfobiz.queryTbEmPrivEcsInfos.biz";
}
public String getShortName(){
  return "queryTbEmPrivEcsInfos.bizx";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo");
      __outputVariables[0].setName("tbemprivecsinfos");
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=this.tbemprivecsinfos;
...
__context.set("tbemprivecsinfos",__return);
    this.tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
{}
if(isSuspend()){
return 70000;
}

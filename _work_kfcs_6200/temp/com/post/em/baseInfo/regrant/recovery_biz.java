package com.post.em.baseInfo.regrant;
import java.io.*;
import java.util.*;
import java.math.*;
...
public class recovery_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
com.eos.data.datacontext.IDataContext sessionContext = null;
Object[] __results = new Object[1];;
commonj.sdo.DataObject temp=com.primeton.ext.data.sdo.helper.ExtendedDataFactory.eINSTANCE.create("com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo");
{__context.addTypeMapping("xpath:/temp","java:null");}
{__context.addTypeMapping("xpath:/temp","sdo:com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo");}
java.lang.String out1;
public recovery_biz(){
     __context.set("temp",temp);
}
public recovery_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("temp",temp);
}
public String getQName(){
  return "com.post.em.baseInfo.regrant.recovery.biz";
}
public String getShortName(){
  return "recovery.bizx";
}
public List<Activity> getActivities(){
  if(this._eosInternal.activities==null){
    ...
    this._eosInternal.activities.add(new Activity("invokePojo0","reGrant","invoke"));
  }
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __inputVariables[0].setDataObjectType("com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo");
      __inputVariables[0].setName("tbemprivecsinfos");
      ...
      __outputVariables[0].setName("out1");
      __outputVariables[0].setTypeClass(java.lang.String.class);
      __outputVariables[0].setTypeName("java.lang.String");
...
private int start0(RuntimeContext __context,commonj.sdo.DataObject[] tbemprivecsinfos) throws Throwable{
...
private int end0(RuntimeContext __context,commonj.sdo.DataObject[] tbemprivecsinfos) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
try{
...
this.beforeHandlers("end0",__context);
  ...
  __results[0]=com.primeton.ext.data.sdo.DataUtil.toString(this.out1);
...
private int invokePojo0(RuntimeContext __context,commonj.sdo.DataObject[] tbemprivecsinfos) throws Throwable{
com.eos.data.datacontext.IDataContext context = __context;
  int __eosCurrentActivityID = -1;
...
__context.setCurrentActivityName("reGrant");
__context.setCurrentActivityType("invoke");
__context.setCurrentActivityValue("com.post.em.baseInfo.ResourceGrantItem.reGrant");
this.beforeHandlers("invokePojo0",__context);
long __startTime=System.currentTimeMillis();
try{
com.post.em.baseInfo.ResourceGrantItem __instance = new com.post.em.baseInfo.ResourceGrantItem();
  __resumeException();
   if(!__context.getAttributes().containsKey("invokePojo0__suspend")){
	  Object __return = __instance.reGrant((commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(tbemprivecsinfos,commonj.sdo.DataObject.class));//pojo:invokePojo0//
__context.setString("str",__return);
if(isSuspend()){
return 70000;
}
}else{
 ...
 if(EngineConfigHandler.getEngineConfigModel().getLogPojoWhenTimeout() >= 0 ){
  ...
  if (__executeTime >= EngineConfigHandler.getEngineConfigModel().getLogPojoWhenTimeout()) {
    com.primeton.ext.common.logging.LoggerFactory.getPojoSysLogger().perform("com.post.em.baseInfo.ResourceGrantItem.reGrant", String.valueOf(__executeTime));
  }
 }
}
  ...
  String __errorMessage = "[FlowName="+this.getQName()+"][activity name=reGrant][activity id=invokePojo0][exception=" +__ex.toString()+"]"; 
  if("true".equals(System.getProperty("EOS_DEBUG"))){
    System.err.println(__errorMessage);
  }
  throw __ex;
...
public Object[] _invoke(commonj.sdo.DataObject[] tbemprivecsinfos) throws Throwable{
       if(isSuspend()){
           return null;
       }
  __context.set("tbemprivecsinfos",tbemprivecsinfos);
  __context.set("temp",temp);
  __context.set("out1",out1);
  __invokeBiz();
  return __results;
}
...
commonj.sdo.DataObject[] tbemprivecsinfos;
try{
 tbemprivecsinfos = (commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__params[0]);
if(tbemprivecsinfos==null){__context.addTypeMapping("xpath:/tbemprivecsinfos","sdo:com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo[]");}
if(tbemprivecsinfos != null){
  commonj.sdo.DataObject[] __rightDataObject = (commonj.sdo.DataObject[])tbemprivecsinfos;
  for(int __i = 0;__i<__rightDataObject.length;__i++){
    if( !(__rightDataObject[__i] instanceof commonj.sdo.DataObject)){
      throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100067,"Param Name:tbemprivecsinfos ,Input param object type: "+tbemprivecsinfos.getClass().getName() +" not match with define:commonj.sdo.DataObject:com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo",new Object[]{this.getQName(),"tbemprivecsinfos",tbemprivecsinfos.getClass().getName(),"commonj.sdo.DataObject:com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo"});
    }
    if(!"com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo".equals(((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getURI() + "." +((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getName()) ){
      throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100068,"Param Name:tbemprivecsinfos ,Input param object type: "+((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getURI() + "." +((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getName()+" not match with define:commonj.sdo.DataObject:com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo",new Object[]{this.getQName(),"tbemprivecsinfos",((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getURI() + "." +((commonj.sdo.DataObject)__rightDataObject[__i]).getType().getName(),"commonj.sdo.DataObject:com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo"});
    }
  }
}
}catch(java.lang.ClassCastException ce){
    throw new EOSEngineRuntimeException(ExceptionConstant.EOSEngineRuntimeException_16100066,"Param Name:tbemprivecsinfos ,Input param object type: "+__params[0].getClass().getName() +" not match with define:commonj.sdo.DataObject",new Object[]{this.getQName(),"tbemprivecsinfos",__params[0].getClass().getName(),"commonj.sdo.DataObject"});
}
log.entry();
...
Object[] results =  _invoke(tbemprivecsinfos);//2//
...
public void __restoreField()  throws Throwable{
      ...
      this.out1=__context.getString("out1");
}
...
private int __choicestart0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbemprivecsinfos;
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=start0(__context,tbemprivecsinfos);
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
__restoreField();
...
private int __choiceend0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbemprivecsinfos;
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=end0(__context,tbemprivecsinfos);
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }
...
private int __choiceinvokePojo0(int __eosCurrentActivityID) throws Throwable{
  commonj.sdo.DataObject [] tbemprivecsinfos;
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
    try{
      __eosCurrentActivityID=invokePojo0(__context,tbemprivecsinfos);
      tbemprivecsinfos=(commonj.sdo.DataObject[])com.primeton.engine.core.impl.helper.DataBuilder.list2Array(__context.get("tbemprivecsinfos"),commonj.sdo.DataObject.class);
__restoreField();
      __context.setCursorId(__eosCurrentActivityID);
    }

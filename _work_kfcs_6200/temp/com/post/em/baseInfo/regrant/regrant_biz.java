...
public class regrant_biz extends com.primeton.engine.core.impl.AbstractJavaBL{
...
public regrant_biz(java.util.Map head,java.util.Map attachment){
super(head,attachment);
     __context.set("temp",temp);
}
public String getQName(){
  return "com.post.em.baseInfo.regrant.regrant.biz";
}

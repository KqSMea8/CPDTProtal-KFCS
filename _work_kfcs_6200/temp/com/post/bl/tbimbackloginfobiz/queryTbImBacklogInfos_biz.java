package com.post.bl.tbimbackloginfobiz;
import java.io.*;
import java.util.*;
import java.math.*;
...
{__context.addTypeMapping("xpath:/tbimbackloginfos","sdo:com.post.bl.backlog.TbImBacklogInfo[]");}
int total;
...
public String getQName(){
  return "com.post.bl.tbimbackloginfobiz.queryTbImBacklogInfos.biz";
}
...
public Variable[] getVariables(String category){
  ...
  if(variables == null){
      ...
      __outputVariables[0].setDataObjectType("com.post.bl.backlog.TbImBacklogInfo");

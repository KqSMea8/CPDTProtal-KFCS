...
- Description:
    ...
    <body style="width:98%;height:95%;">
        <div class="nui-panel" title="人员信息查询" iconCls="icon-add" style="width:100%;height:15%;" showToolbar="false" showFooter="true">
            <div id="form1" class="nui-form" align="center" style="height:100%">
                ...
                <table id="table1" class="table" style="height:100%">
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="tlrno"/>
                        </td>
                        <td class="form_label">
                            人员名称:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" name="tlrname"/>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="nui-panel" title="TbImItemsInfo列表" iconCls="icon-add" style="width:100%;height:85%;" showToolbar="false" showFooter="false" >

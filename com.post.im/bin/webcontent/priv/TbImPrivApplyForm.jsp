...
- Description:
    ...
    <body>
        ...
        <div id="dataform1" style="padding-top:5px;">
            <!-- hidden域 -->
            <input class="nui-hidden" name="tbimprivapply.recId"/>
...
<!--                         申请状态: -->
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" name="tbimprivapply.openStat" visible="false" value="01"/>
                    </td>
                    <td class="form_label">
                        审批备注:
                    </td>
...
<!--                     </td> -->
<!--                     <td colspan="1"> -->
<!--                         <input class="nui-textbox" name="tbimprivapply.field1"/> -->
<!--                     </td> -->
<!--                     <td class="form_label"> -->
<!--                         备用2: -->
<!--                     </td> -->
<!--                     <td colspan="1"> -->
<!--                         <input class="nui-textbox" name="tbimprivapply.field2"/> -->
<!--                     </td> -->
<!--                 </tr> -->
                <tr>
                    <td class="form_label">

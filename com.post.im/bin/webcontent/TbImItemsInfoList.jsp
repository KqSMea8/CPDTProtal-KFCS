...
- Description:
    ...
    <body style="width:98%;height:95%;">
        <div class="nui-panel" title="项目信息查询" iconCls="icon-add" style="width:100%;height:15%;" showToolbar="false" showFooter="true">
            <div id="form1" class="nui-form" align="center" style="height:100%">
                <!-- 数据实体的名称 -->
                <input class="nui-hidden" name="criteria/_entity" value="com.post.im.itemsM.itemsM.TbImItemsInfo">
                <!-- 排序字段 -->
                <input class="nui-hidden" name="criteria/_orderby[1]/_property" value="itemsCd">
                ...
                <table id="table1" class="table" style="height:100%">
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[2]/itemsNm"/>
        ...
        <div class="nui-panel" title="项目信息列表" iconCls="icon-add" style="width:100%;height:85%;" showToolbar="false" showFooter="false" >
...
<!--                         </div> -->
        ...
        <script type="text/javascript">
            ...
            function add() {
                nui.open({
                    url: "/kfcs/im/TbImItemsInfoForm.jsp",
                ...
                if (row) {
                    ...
                    function remove(){
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tbimitemsinfos:rows});

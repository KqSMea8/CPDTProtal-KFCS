...
- Description:
    ...
    <body style="width:98%;height:95%;">
        <div class="nui-panel" title="物理机资源列表查询" iconCls="icon-add" style="width:100%;height:15%;" showToolbar="false" showFooter="true">
            <div id="form1" class="nui-form" align="center" style="height:100%">
                <!-- 数据实体的名称 -->
                <input class="nui-hidden" name="criteria/_entity" value="com.post.im.resourceM.phys.phys.TbImPhysApply">
                <!-- 排序字段 -->
        ...
        <div class="nui-panel" title="物理机资源列表" iconCls="icon-add" style="width:100%;height:85%;" showToolbar="false" showFooter="false" >
            ...
            <div class="nui-fit">
                <div id="datagrid1" dataField="tbimphysapplys" class="nui-datagrid" style="width:100%;height:100%;" url="com.post.im.tbimphysapplybiz.queryTbImPhysApplys.biz.ext" pageSize="10" showPageInfo="true" multiSelect="true" onselectionchanged="selectionChanged" allowSortColumn="false">
...
<!--                         </div> -->
        ...
        <script type="text/javascript">
            ...
            function add() {
                nui.open({
                    url: "kfcs/im/phys/TbImPhysApplyForm.jsp",
            ...
            function edit() {
                ...
                if (row) {
                    nui.open({
                        ...
                        onload: function () {
                            var iframe = this.getIFrameEl();
                            var data = {pageType:"edit",record:{tbimphysapply:row}};
                            //直接从页面获取，不用去后台获取
                            iframe.contentWindow.setFormData(data);
                            },
                    ...
                    function remove(){
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tbimphysapplys:rows});
                                    grid.loading("正在删除中,请稍等...");
                                    $.ajax({
                                        url:"com.post.im.tbimphysapplybiz.deleteTbImPhysApplys.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,

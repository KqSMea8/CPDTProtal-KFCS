...
public class JedisUtil {
	...
	// ConfigurationUtil.getUserConfigSingleValue(
	// "DistributeCache", "Redis", "Url");
	// private static final String Port =
	// ConfigurationUtil.getUserConfigSingleValue(
	// "DistributeCache", "Redis", "Port");
	// private static final String MaxIdle =
	// ConfigurationUtil.getUserConfigSingleValue(
	// "DistributeCache", "Redis", "MaxIdle");
	// private static final String MaxTotal =
	// ConfigurationUtil.getUserConfigSingleValue(
	// "DistributeCache", "Redis", "MaxTotal");
	// private static final String
	// MaxWaitMillis=ConfigurationUtil.getUserConfigSingleValue(
	// "DistributeCache", "Redis", "MaxWaitMillis");
	//
	...
	static {
//		 String Ip = "192.168.246.153";
//		 String Port = "9211";
//		 String MaxIdle = "5";
//		 String MaxTotal = "20";
//		 String MaxWaitMillis = "200";
//		 String redisPassword="Wc123456";
//		 String timeOut="200";

		String Ip = ConfigurationUtil.getUserConfigSingleValue("Logfilter",
				"Redis", "Ip");
		String Port = ConfigurationUtil.getUserConfigSingleValue("Logfilter",
				"Redis", "Port");
		String MaxIdle = ConfigurationUtil.getUserConfigSingleValue(
				"Logfilter", "Redis", "MaxIdle");
		String MaxTotal = ConfigurationUtil.getUserConfigSingleValue(
				"Logfilter", "Redis", "MaxTotal");
		String MaxWaitMillis = ConfigurationUtil.getUserConfigSingleValue(
				"Logfilter", "Redis", "MaxWaitMillis");
		String redisPassword = ConfigurationUtil.getUserConfigSingleValue(
				"Logfilter", "Redis", "RedisPassword");
		String timeOut = ConfigurationUtil.getUserConfigSingleValue(
				"Logfilter", "Redis", "TimeOut");
		...
		if (StringUtil.isBlank(redisPassword)) {
			...
			jedisPool = new JedisPool(config, Ip, Integer.parseInt(Port),
					Integer.parseInt(timeOut), redisPassword);
		}
	...
	public boolean exists(final String key) {
		...
		returnJedis(jedis);
		return flag;
		// JedisUtil.Keys keys = new JedisUtil.Keys();
	 ...
	 */
	public Object get(final String key) throws SerializationException,
		...
		if (result != null) {
			...
			Object objectValue = serializer.deserialize(result
					.getBytes("UTF-8"));
			return objectValue;

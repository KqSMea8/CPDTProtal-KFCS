...
- Description:
    ...
    <body style="width:98%;height:95%;">
        <div class="nui-panel" title="私有云资源服务器信息查询" iconCls="icon-add" style="width:100%;height:15%;" showToolbar="false" showFooter="true">
            <div id="form1" class="nui-form" align="center" style="height:100%">
                <!-- 数据实体的名称 -->
                <input class="nui-hidden" name="criteria/_entity" value="com.post.em.baseInfo.emPrivInfo.TbEmPrivEcsInfo">
                <!-- 排序字段 -->
                ...
                <table id="table1" class="table" style="height:100%">
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[1]/ecsIp"/>
        ...
        <div class="nui-panel" title="私有云资源信息列表" iconCls="icon-add" style="width:100%;height:85%;" showToolbar="false" showFooter="false" >
            ...
            <div class="nui-fit">
                <div id="datagrid1" dataField="tbemprivecsinfos" class="nui-datagrid" style="width:100%;height:100%;" url="com.post.em.tbemprivecsinfobiz.queryTbEmPrivEcsInfos.biz.ext" pageSize="10" showPageInfo="true" multiSelect="true" onselectionchanged="selectionChanged" allowSortColumn="false">
                    <div property="columns">
                        ...
                        <div field="ecsIp" headerAlign="center" allowSort="true" >
                            私有资源IP地址
                        </div>
        ...
        <script type="text/javascript">
            ...
            function add() {
                nui.open({
                    url: "/kfcs/em/TbEmPrivEcsInfoForm.jsp",
            ...
            function grant() {
                ...
                if (rows.length>0) {
                    ...
                    for (var i=0;i <rows.length;i++){
                     ...
                     var json = nui.encode({tbemprivecsinfos:rows});
                   // var json = nui.encode(rows);
                     $.ajax({
                                        url:"com.post.em.baseInfo.regrant.regrant.biz.ext",
            ...
            function recovery() {
                ...
                if (rows.length>0) {
                    ...
                    for (var i=0;i <rows.length;i++){
                     ...
                     var json = nui.encode({tbemprivecsinfos:rows});
                      $.ajax({
                                        url:"com.post.em.baseInfo.regrant.recovery.biz.ext",
            ...
            function edit() {
                ...
                if (row) {
                    nui.open({
                        ...
                        onload: function () {
                            var iframe = this.getIFrameEl();
                            var data = {record:{tbemprivecsinfos:rows}};
                            //直接从页面获取，不用去后台获取
                            iframe.contentWindow.setFormData(data);
                            },
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({
                                        url:"com.post.em.tbemprivecsinfobiz.deleteTbEmPrivEcsInfos.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
